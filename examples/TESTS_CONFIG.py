...
Resolve Syncbot example-suite paths from project config.
"""
...
def main() -> int:
    ...
    payload = {
        ...
        "test_logs_folder": str(_resolve(cfg, "TESTS_LOGS", ("TESTS_LOGS", "TEST_LOGS"), ".tests_logs/Syncbot/")),
        "logs_folder": str(_resolve(cfg, "LOG_PATHS", ("LOG_PATHS", "LOGS"), ".logs/Syncbot/")),
